...
\def\invariant{0} %1: include contents on Invariants, others otherwise (for chapter 7 only)
...
\degree{Computer Science \\[1ex] (in C++)}     %the degree
\degreedate{April 2023}         %the degree date
